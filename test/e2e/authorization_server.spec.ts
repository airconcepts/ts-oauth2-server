...
describe("authorization_server", () => {
  ...
  describe("#introspect", () => {
    ...
    const parsedAccessToken = jose.decodeJwt(accessTokenJWT) as ParsedAccessToken;
    ...
    const parsedRefreshToken = jose.decodeJwt(refreshTokenJWT) as ParsedRefreshToken;
